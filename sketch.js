...
function setup() {
	...
	rope2 = new Rope(bob2.body,hanger.body,-bobDiameter*2,0);
	rope3 = new Rope(bob3.body,hanger.body,-bobDiameter*2,0);
	rope4 = new Rope(bob4.body,hanger.body,-bobDiameter*2,0);
